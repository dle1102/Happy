...
const ringTexts = [
  'Huỳnh Thị Mỹ Duyên',//untuk deskripsi planet layer 1
  "Tuổi mới thêm nhiều niềm vui",//untuk deskripsi planet layer 2
  "♡Happy Birthday♡",//untuk deskripsi planet layer 3
  "22/10/2005",//untuk deskripsi planet layer 4
...
function createTextRings() {
  ...
  for (let i = 0; i < numRings; i++) {
    ...
    ctx.textBaseline = 'alphabetic';
      ...
      ctx.shadowColor = '#000'; // bóng tối nhẹ để tách khỏi nền
      ctx.shadowBlur = 8;
      ctx.lineWidth = 4;
      ctx.strokeStyle = '#b26dff'; // viền tím nhạt
      ctx.strokeText(fullText, 0, textureHeight * 0.8);

      // Lớp chữ chính màu sáng nhưng không trắng toát
      ctx.shadowColor = '#ffccff'; // ánh sáng hồng tím
      ctx.shadowBlur = 12;
      ctx.fillStyle = '#f8eaff'; // tím sữa nhẹ
